            ...
            <Section classes={`flex items-center justify-center flex-col`}>
                <div className="w-fit text-left">
                    ...
                    <div className="flex justify-center items-center gap-2 w-full mt-4">
                        <HoverIcon href="https://github.com/mattpetts" icon={ GithubOutlined } size={ 30 } label="Github" />
                        <HoverIcon href="https://www.linkedin.com/in/matt-petts-51230968/" icon={ LinkedinOutlined } size={ 30 } label="LinkedIn" />
                        <HoverIcon href="mailto:mattpetts23@gmail.com" icon={ Envelope1Outlined } size={ 30 } label="Email" />
                    </div>
                </div>
            </Section>
        </div>
